const assetsPrefix = 'https://stu-resume-website.s3.us-west-1.amazonaws.com/frogger-assets/';
...
export var game = {
  ...
  // ------------ Audio ----------------
  audio: {
    win: `${assetsPrefix}win.mp3`,
    move: `${assetsPrefix}move.mp3`,
    extra: `${assetsPrefix}extra.mp3`,
    background: `${assetsPrefix}background.mp3`,
    splash: `${assetsPrefix}splash.mp3`,
    squash: `${assetsPrefix}squash.mp3`,
    time: `${assetsPrefix}time.mp3`,
  },
